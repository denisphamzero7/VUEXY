...
import { db } from '@db/apps/newacademy/db'
import { paginateArray } from '@api-utils/paginateArray'

export const handlerAppsNewAcademy = [
  // 👉 Course
  http.get(('/api/apps/newacademy/courses'), ({ request }) => {
  ...
  // 👉 Course Details
  http.get(('/api/apps/newacademy/course-details'), () => {
