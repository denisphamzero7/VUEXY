...
import { db } from '@db/apps/newusers/db'
import { paginateArray } from '@api-utils/paginateArray'

export const handlerAppsNewUsers = [
  // Get Users Details
  http.get(('/api/apps/newusers'), ({ request }) => {
  ...
  http.get(('/api/apps/newusers/:id'), ({ params }) => {
  ...
  // Delete User
  http.delete(('/api/apps/newusers/:id'), ({ params }) => {
    const userId = Number(params.id)
