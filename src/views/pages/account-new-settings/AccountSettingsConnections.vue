...
const connectedAccounts = ref([
  ...
  },
  {
    logo: github,
    name: 'GitHub',
    subtitle: 'Quản lý kho Git của bạn',
    connected: true,
  },
  {
    logo: mailchimp,
    name: 'MailChimp',
    color: 'yellow',
    subtitle: 'Dịch vụ tiếp thị qua email',
    connected: true,
  },
  {
    logo: asana,
    ...
    <VRow>
      ...
      >
        ...
        <VCard
          ...
          subtitle="Hiển thị nội dung từ các tài khoản được kết nối của bạn trên trang web của bạn"
          flat
        >
          <VCardText>
      ...
      >
        ...
        <VCard
          ...
          subtitle="Hiển thị nội dung từ các tài khoản mạng xã hội trên trang web của bạn"
          flat
        >
          <VCardText>
            <VList class="card-list">
