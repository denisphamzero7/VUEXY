...
const menuItems = [
  ...
  {
    listTitle: 'Demo xác thực',
    listIcon: 'tabler-lock-open',
    navItems: [
      {
        name: 'Đăng nhập (Cơ bản)',
        to: { name: 'pages-authentication-login-v1' },
      },
      {
        name: 'Đăng nhập (Cover)',
      ...
      {
        name: 'Đăng ký (Nhiều bước)',
        to: { name: 'pages-authentication-register-multi-steps' },
      },
      {
        name: 'Quên mật khẩu (Cơ bản)',
        to: { name: 'pages-authentication-forgot-password-v1' },
      },
      {
        name: 'Quên mật khẩu (Cover)',
        to: { name: 'pages-authentication-forgot-password-v2' },
      },
      {
        name: 'Đặt lại mật khẩu (Cơ bản)',
        to: { name: 'pages-authentication-reset-password-v1' },
      },
      {
        name: 'Đặt lại mật khẩu (Cover)',
    ...
    >
      ...
      <div>
        <div class="d-flex flex-column gap-y-4 pa-4">
          <RouterLink
            v-for="(item, index) in ['Trang chủ', 'Tính năng', 'Đội ngũ', 'Câu hỏi thường gặp', 'Liên hệ']"
            :key="index"
            :to="{ name: 'front-newpages-landing-page', hash: `#${item.toLowerCase().replace(' ', '-')}` }"
          ...
          <div class="font-weight-medium cursor-pointer">
            ...
            >
              Trang <VIcon :icon="isMenuOpen ? 'tabler-chevron-up' : 'tabler-chevron-down'" />
            </div>
              ...
              >
                ...
                <ul class="mb-6">
                  ...
                  >
                    <RouterLink
                      :to="listItem.to"
                      :target="item.listTitle === 'Trang' ? '_self' : '_blank'"
