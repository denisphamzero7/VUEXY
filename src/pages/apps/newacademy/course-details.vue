...
const { data, error } = await useApi('/apps/newacademy/course-details')
if (error.value)
...
<template>
  <VRow>
    ...
    >
      <VCard>
        <VCardItem
          title="Nguyên tắc cơ bản về UI/UX"
          class="pb-6"
        >
          <template #subtitle>
            <div class="text-body-1">
              Giảng viên: <span class="text-h6 d-inline-block">{{ courseDetails?.instructor }}</span>
            </div>
          </template>
          <template #append>
                ...
                <div>
                  <VList class="card-list text-medium-emphasis">
                    <VListItem>
                      ...
                      <VListItemTitle>Trình độ kỹ năng: {{ courseDetails?.skillLevel }}</VListItemTitle>
                    </VListItem>
                    <VListItem>
                      <template #prepend>
                        <VIcon
                      ...
                      <VListItemTitle>Số học viên: {{ courseDetails?.totalStudents }}</VListItemTitle>
                    </VListItem>
                    <VListItem>
                      <template #prepend>
                        <VIcon
                      ...
                      <VListItemTitle>Ngôn ngữ: {{ courseDetails?.language }}</VListItemTitle>
                    </VListItem>
                    <VListItem>
                      <template #prepend>
                        <VIcon
                      ...
                      <VListItemTitle>Phụ đề: {{ courseDetails?.isCaptions }}</VListItemTitle>
                    </VListItem>
                  </VList>
                </div>
                ...
                <div>
                  <VList class="card-list text-medium-emphasis">
                    <VListItem>
                      ...
                      <VListItemTitle>Số bài giảng: {{ courseDetails?.totalLectures }}</VListItemTitle>
                    </VListItem>
                    <VListItem>
                      <template #prepend>
                        <VIcon
                      ...
                      <VListItemTitle>Thời lượng video: {{ courseDetails?.length }}</VListItemTitle>
                    </VListItem>
                  </VList>
                </div>
              </div>
