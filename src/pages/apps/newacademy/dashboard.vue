<script setup>
import AcademyAssignmentProgress from '@/views/apps/newacademy/AcademyAssignmentProgress.vue'
import AcademyCardPopularInstructors from '@/views/apps/newacademy/AcademyCardPopularInstructors.vue'
import AcademyCardTopCourses from '@/views/apps/newacademy/AcademyCardTopCourses.vue'
import AcademyCourseTable from '@/views/apps/newacademy/AcademyCourseTable.vue'
import AcademyTopicYouAreInterested from '@/views/apps/newacademy/AcademyTopicYouAreInterested.vue'
import AcademyUpcomingWebinar from '@/views/apps/newacademy/AcademyUpcomingWebinar.vue'
      ...
      >
        <div class="pe-3">
          <h5 class="text-h5 mb-2">
            Chào mừng trở lại,<span class="text-h4"> Hậu 👋🏻 </span>
          </h5>
          ...
          >
            Tuần này tiến độ của bạn rất tốt. Hãy giữ phong độ để nhận được nhiều điểm thưởng!
          </div>

          <div class="d-flex justify-space-between flex-wrap gap-4 flex-column flex-md-row mt-4">
            <div
              v-for="{ title, value, icon, color } in [
                { title: 'Giờ học', value: '34h', icon: customLaptop, color: 'primary' },
                { title: 'Kết quả kiểm tra', value: '82%', icon: customLightbulb, color: 'info' },
                { title: 'Khóa học hoàn thành', value: '14', icon: customCheck, color: 'warning' },
              ]"
              :key="title"
            >
