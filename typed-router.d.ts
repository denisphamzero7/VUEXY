...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'pages-user-detailuser': RouteRecordInfo<'pages-user-detailuser', '/pages/user/detailuser', Record<never, never>, Record<never, never>>,
    'pages-user-detail-user': RouteRecordInfo<'pages-user-detail-user', '/pages/user/DetailUser', Record<never, never>, Record<never, never>>,
