...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-newacademy-course-details': RouteRecordInfo<'apps-newacademy-course-details', '/apps/newacademy/course-details', Record<never, never>, Record<never, never>>,
    'apps-newacademy-dashboard': RouteRecordInfo<'apps-newacademy-dashboard', '/apps/newacademy/dashboard', Record<never, never>, Record<never, never>>,
    'apps-newacademy-my-course': RouteRecordInfo<'apps-newacademy-my-course', '/apps/newacademy/my-course', Record<never, never>, Record<never, never>>,
    'apps-newlogistics-dashboard': RouteRecordInfo<'apps-newlogistics-dashboard', '/apps/newlogistics/dashboard', Record<never, never>, Record<never, never>>,
    'apps-newlogistics-fleet': RouteRecordInfo<'apps-newlogistics-fleet', '/apps/newlogistics/fleet', Record<never, never>, Record<never, never>>,
    'apps-newpermissions': RouteRecordInfo<'apps-newpermissions', '/apps/newpermissions', Record<never, never>, Record<never, never>>,
    'apps-newroles': RouteRecordInfo<'apps-newroles', '/apps/newroles', Record<never, never>, Record<never, never>>,
    'apps-permissions': RouteRecordInfo<'apps-permissions', '/apps/permissions', Record<never, never>, Record<never, never>>,
    'apps-report-batches-list-target': RouteRecordInfo<'apps-report-batches-list-target', '/apps/report-batches/list/:target', { target: ParamValue<true> }, { target: ParamValue<false> }>,
    'apps-report-categories-list': RouteRecordInfo<'apps-report-categories-list', '/apps/report-categories/list', Record<never, never>, Record<never, never>>,
    'apps-report-submssions-target': RouteRecordInfo<'apps-report-submssions-target', '/apps/report-submssions/:target', { target: ParamValue<true> }, { target: ParamValue<false> }>,
    ...
    'dashboards-analytics2': RouteRecordInfo<'dashboards-analytics2', '/dashboards/analytics2', Record<never, never>, Record<never, never>>,
    ...
    'newdashboards-analytics': RouteRecordInfo<'newdashboards-analytics', '/newdashboards/analytics', Record<never, never>, Record<never, never>>,
    'newdashboards-crm': RouteRecordInfo<'newdashboards-crm', '/newdashboards/crm', Record<never, never>, Record<never, never>>,
    'newdashboards-ecommerce': RouteRecordInfo<'newdashboards-ecommerce', '/newdashboards/ecommerce', Record<never, never>, Record<never, never>>,
    'not-authorized': RouteRecordInfo<'not-authorized', '/not-authorized', Record<never, never>, Record<never, never>>,
    'pages-account-new-settings-tab': RouteRecordInfo<'pages-account-new-settings-tab', '/pages/account-new-settings/:tab', { tab: ParamValue<true> }, { tab: ParamValue<false> }>,
    ...
    'pages-baocao': RouteRecordInfo<'pages-baocao', '/pages/baocao', Record<never, never>, Record<never, never>>,
    'pages-baocao-filter-panel': RouteRecordInfo<'pages-baocao-filter-panel', '/pages/baocao/FilterPanel', Record<never, never>, Record<never, never>>,
    'pages-baocao-listbaocao': RouteRecordInfo<'pages-baocao-listbaocao', '/pages/baocao/listbaocao', Record<never, never>, Record<never, never>>,
    'pages-baocao-report-list': RouteRecordInfo<'pages-baocao-report-list', '/pages/baocao/ReportList', Record<never, never>, Record<never, never>>,
    'pages-baocao-stat-card': RouteRecordInfo<'pages-baocao-stat-card', '/pages/baocao/StatCard', Record<never, never>, Record<never, never>>,
    ...
    'pages-faqnew': RouteRecordInfo<'pages-faqnew', '/pages/faqnew', Record<never, never>, Record<never, never>>,
    'pages-icons': RouteRecordInfo<'pages-icons', '/pages/icons', Record<never, never>, Record<never, never>>,
    'pages-loginview': RouteRecordInfo<'pages-loginview', '/pages/loginview', Record<never, never>, Record<never, never>>,
    ...
    'pages-monitor': RouteRecordInfo<'pages-monitor', '/pages/monitor', Record<never, never>, Record<never, never>>,
    'pages-monitor-form-monitor': RouteRecordInfo<'pages-monitor-form-monitor', '/pages/monitor/form-monitor', Record<never, never>, Record<never, never>>,
    'pages-my-component': RouteRecordInfo<'pages-my-component', '/pages/my-component', Record<never, never>, Record<never, never>>,
    'pages-my-component-my-input': RouteRecordInfo<'pages-my-component-my-input', '/pages/my-component/MyInput', Record<never, never>, Record<never, never>>,
    'pages-my-profile-tab': RouteRecordInfo<'pages-my-profile-tab', '/pages/my-profile/:tab', { tab: ParamValue<true> }, { tab: ParamValue<false> }>,
    'pages-pricing': RouteRecordInfo<'pages-pricing', '/pages/pricing', Record<never, never>, Record<never, never>>,
    'pages-pricingnew': RouteRecordInfo<'pages-pricingnew', '/pages/pricingnew', Record<never, never>, Record<never, never>>,
    'pages-typography': RouteRecordInfo<'pages-typography', '/pages/typography', Record<never, never>, Record<never, never>>,
    'pages-user-adduser': RouteRecordInfo<'pages-user-adduser', '/pages/user/adduser', Record<never, never>, Record<never, never>>,
    'pages-user-detailuser-id': RouteRecordInfo<'pages-user-detailuser-id', '/pages/user/detailuser/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'pages-user-list': RouteRecordInfo<'pages-user-list', '/pages/user/list', Record<never, never>, Record<never, never>>,
    'pages-user-user-dialog': RouteRecordInfo<'pages-user-user-dialog', '/pages/user/UserDialog', Record<never, never>, Record<never, never>>,
